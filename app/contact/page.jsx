					...
					<div className="breadcrumb-wrapper">
						...
						<div className="global-container">
							<div className="breadcrumb-block pt-6 sm:pt-0">
								<h1 className="breadcrumb-title text-2xl md:text-3xl font-bold">Contact Us</h1>
								...
								<div className="order-2 flex flex-col md:order-1">
									...
									<div className="text-lg leading-[1.4] lg:text-[21px]">
										<p className="mb-7 last:mb-0">
											We&apos;re here to help you harness the power of AI for your business. Reach out to discuss how our AI solutions can drive innovation and growth. Our team will respond within 24 hours.
										</p>
